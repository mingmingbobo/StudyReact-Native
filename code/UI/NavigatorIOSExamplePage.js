...
import { AppRegistry, Text, View ,StyleSheet ,TabBarIOS,NavigatorIOS,ScrollView,TouchableHighlight,AlertIOS} from 'react-native';
        ...
        <View style={styles.group}>
          ...
          {this._renderRow('Custom title image Example', () => {
            this.props.navigator.push({
              ...
              titleImage: require('./image/tips_red_icon.png'),
              component: createExamplePage(null, ViewExample),
            });
          })}
...
module.exports = NavigatorIOSExamplePage
